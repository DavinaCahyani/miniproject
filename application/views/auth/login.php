...
<body class="background container py-5 ">
    <div class="card justify-content-center mx-auto" style="width: 20rem;">
        <div class="card-body">
            <form action="<?php echo base_url();?>auth/aksi_login" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control btn btn-sm btn-light" id="exampleFormControlInput1"
                        placeholder="Email" name="email">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Password</label>
                    <input type="password" class="form-control btn btn-sm btn-light" id="password"
        ...
        <div>
            <p class="text-center">Belum punya akun? <a href="auth/register">Register</a></p>
        </div>
        </form>
    </div>
    </div>
